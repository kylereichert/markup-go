...
func initialModel() model {
	...
	for i := range m.inputs {
		...
		// Replace this for our own use. underside of joist, atf, that sort of
		// thing. Maybe add fields dynamically for arbitrary elevations?
		switch i {
		case 0:
...
func (m model) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case tea.KeyMsg:
		...
		// Change cursor mode. Don't think I want different cursors, may delete later
